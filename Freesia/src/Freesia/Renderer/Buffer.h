...
#ifndef FREESIA_BUFFER_H
#define FREESIA_BUFFER_H
...
namespace Freesia
{
    ...
    constexpr uint32_t ShaderDataTypeSize(ShaderDataType type) // returns in bytes
    {
        switch (type)
        {
    ...
    struct BufferElement
    {
        ...
        uint32_t GetComponentCount() const // returns in count
        {
            switch (Type)
            {
    ...
    class IndexBuffer // Currently, index buffers only support 32-bit Integers
    {
    public:
